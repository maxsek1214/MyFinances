...
data class FlowOfFund(
        ...
        @Relation(parentColumn = "cashAccount_id", entityColumn = "id", entity = CashAccountEntity::class)
        val cashAccountEntity: CashAccountEntity,
        @Relation(parentColumn = "cashTransaction_id", entityColumn = "id", entity = CashTransactionEntity::class)
