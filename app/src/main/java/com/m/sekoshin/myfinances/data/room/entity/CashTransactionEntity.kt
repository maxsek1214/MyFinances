...
@Entity(
    ...
    foreignKeys = [
        ...
        ForeignKey(
            ...
            parentColumns = arrayOf("id"),
            childColumns = arrayOf("transactionCategory_id")
        ),
        ForeignKey(
            entity = SourceRecipientEntity::class,
            parentColumns = arrayOf("id"),
            childColumns = arrayOf("sourceRecipient_id")
        )
    ],
    indices = [Index(value = arrayOf("transactionCategory_id")), Index(value = arrayOf("sourceRecipient_id")), Index(
        value = arrayOf("cashiersCheck_id")
    )]
)
