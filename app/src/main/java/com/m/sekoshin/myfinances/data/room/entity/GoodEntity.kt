...
@Entity(
        ...
        foreignKeys = [
            ForeignKey(entity = AliasEntity::class, parentColumns = arrayOf("id"), childColumns = arrayOf("alias_id")),
            ForeignKey(entity = GoodCategoryEntity::class, parentColumns = arrayOf("id"), childColumns = arrayOf("goodsCategory_id"))
        ],
