...
@Entity(
        ...
        foreignKeys = [
            ForeignKey(entity = CashAccountEntity::class, parentColumns = arrayOf("id"), childColumns = arrayOf("cashAccount_id")),
            ForeignKey(entity = CashTransactionEntity::class, parentColumns = arrayOf("id"), childColumns = arrayOf("cashTransaction_id"))
        ],
